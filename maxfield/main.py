...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-ol', '--max_outgoing_links', type=int, default=8,
        help=('The maximum of outgoing links '
              'from an any portal.'))
    parser.add_argument(
        '-md', '--count_already_made_links', action='store_true',
        help=('Count in the maximum, links that '
              'has been already made in intel map.'))
